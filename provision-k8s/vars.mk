...
# Jaeger Version Number as written in the GitHub Release page
JAEGER_OPERATOR_VERSION := v1.17.1
JAEGER_OPERATOR_NS := jaeger-system

# Elastic Cloud Kubernetes Operator Version
ECK_VERSION := 1.0.1
